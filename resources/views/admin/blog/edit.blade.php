...
@section('content')
        ...
        <div class="section__content section__content--p30">
            <div class="row">
                <div id="app" class="w-100">
                    ...
                    {!! Form::open(['method' => 'put','route' => ['admin-blog.update', $article->id],'files' => true,
                            'multiple' => 'multiple'])!!}
                        <div class="mb-3 d-flex align-items-center justify-content-between">
                            <strong>Редактирвание {{ $article->title }}</strong>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" >
                                ...
                                <select name="category" id="category" class="form-control">
                                    ...
                                    @foreach($categories as $category)
                                        <option @if($article->category_id == $category->id) selected @endif value="{{ $category->id }}">{{ $category->title }}</option>
                                    @endforeach
                                ...
                                @if($article->image)
                                    <div class="col-md-3">
                                        <img class="col-md-12" src="{{ asset('/house/uploads/' . $article->image) }}" alt="">
                                    </div>
    ...
    <!-- <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            <h1>Редактирвание {{ $article->title }}</h1>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    {{--<div class="form-group col-md-12">
                        ...
                        <textarea name="short_desc" id="short_desc" cols="30" rows="7" class="form-control">{{ $article->short_desc }}</textarea>
                    </div>
                    <div class="form-group col-md-12">
                        <label>Описание</label>
                        <editor-component :v="{{ json_encode($article->full_desc) }}" :name="{{ json_encode('full_desc') }}"></editor-component>
                    </div>--}}
