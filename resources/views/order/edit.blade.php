...
@section('content')
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            <div class="row">
                <order-component :order="{{ json_encode($order)}}" :products="{{ json_encode($products) }}" :regi="{{ json_encode($regions) }}" :cit="{{ json_encode($cities) }}" :ware="{{ json_encode($warehouses) }}"></order-component>
            </div>
        </div>
    </div>
