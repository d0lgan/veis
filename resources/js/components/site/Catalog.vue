            ...
            <div class="holder catalog__holder">
                <div class="catalog-filters">
                    ...
                    <div class="catalog-filters__box">
                        <div class="catalog-filters__block" v-if="dropdown.length">
                ...
                <div class="catalog__box" style="width: 100%;">
                    ...
                    <div class="catalog__products">
                        ...
                        <div class="product__iteam" @click="loadMoreProducts()" v-if="pageCount - selected.fakePageForMoreProducts > 1">
