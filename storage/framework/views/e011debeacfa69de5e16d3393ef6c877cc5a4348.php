<?php $__currentLoopData = $langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="tab-pane <?php echo e($key == 0 ? 'active' : null); ?>"
        ...
        <?php if(isset($name)): ?>
            <?php $method = "name_" . $lang->locate_code ?>
            <div class="form-group">
                <label for="title_<?php echo e($lang->locate_code); ?>"><?php echo e(isset($title_name) ? $title_name . ':' : 'Название:'); ?></label>
                <input required name="title_<?php echo e($lang->locate_code); ?>"
                       id="title_<?php echo e($lang->locate_code); ?>"
        ...
        <?php if(isset($link)): ?>
            <?php $method = "link_" . $lang->locate_code ?>
            <div class="form-group">
                <label for="title_<?php echo e($lang->locate_code); ?>"><?php echo e(isset($link_name) ? $link_name . ':' : 'Ссылка:'); ?></label>
                <input required name="link_<?php echo e($lang->locate_code); ?>"
                       id="title_<?php echo e($lang->locate_code); ?>"
                       value="<?php echo e(@optional($item)->$method); ?>"
                       placeholder="Link <?php echo e(strtoupper($lang->locate_code)); ?>"
                       type="text"
                       class="form-control"/>
            </div>
        <?php endif; ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/veisdpua/test.veis.dp.ua/resources/views/admin/partials/title.blade.php ENDPATH**/ ?>