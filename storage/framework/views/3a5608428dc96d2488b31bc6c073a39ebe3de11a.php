        ...
        <div class="section__content section__content--p30">
            <div class="row">
                <div id="app" class="w-100">
                    ...
                    <div class="w-100">
                        <form method="post" action="<?php echo e(route('admin-attribute.store')); ?>">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group w-100 d-flex align-items-center justify-content-between">
                                        <div class="form-group col-6">
                                            ...
                                            <group-attributes-component :group="<?php echo e(json_encode($group_attributes)); ?>"></group-attributes-component>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/veisdpua/test.veis.dp.ua/resources/views/admin/attribute/create.blade.php ENDPATH**/ ?>