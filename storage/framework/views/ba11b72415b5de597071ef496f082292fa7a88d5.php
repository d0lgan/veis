    ...
    <div class="tab-pane <?php echo e($key == 0 ? 'active' : null); ?>"
        ...
        <?php endif; ?>
            ...
            <?php if(isset($manufacturer_url)): ?>
                <div class="form-group">
                    <label for="slug">Url</label>
                    <input type="text" name="slug" value="<?php echo e($manufacturer->slug); ?>" class="form-control">
                </div>
            <?php endif; ?>
        ...
        <?php if($description): ?>
            <div class="form-group">
                ...
                <!-- <span><?php echo e(json_encode(@optional($item)->data[$lang->locate_code]['description'] ?: old('description_' . $lang->locate_code)) ? 'true' : 'false'); ?></span> -->
                <div class="w-100">
                  <editor-component :name="<?php echo e(json_encode('description_' . $lang->locate_code)); ?>" :v="<?php echo e(json_encode(@optional($item)->data[$lang->locate_code]['description'] ?: old('description_' . $lang->locate_code)) == 'null' ? json_encode(@optional($item)->description) : json_encode(@optional($item)->data[$lang->locate_code]['description'] ?: old('description_' . $lang->locate_code))); ?>"></editor-component>
                </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH W:\domains\veisshop\resources\views/admin/partials/url.blade.php ENDPATH**/ ?>