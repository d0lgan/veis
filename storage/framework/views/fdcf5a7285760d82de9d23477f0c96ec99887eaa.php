        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link" href="<?php echo e(route('about')); ?>"><?php echo app('translator')->getFromJson('navbar.about'); ?></a>
                    <a class="nav-item nav-link" href="<?php echo e(route('contact')); ?>"><?php echo app('translator')->getFromJson('navbar.contacts'); ?></a>
...
<?php /**PATH W:\domains\veisshop\resources\views/layouts/site/app.blade.php ENDPATH**/ ?>