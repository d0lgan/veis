                                    ...
                                    <div class="col-md-4 form-group">
                                        <div id="app">
                                            <select-component :default="<?php echo e(json_encode($product->categories)); ?>"
                                                              ...
                                                              :title="<?php echo e(json_encode('Дополнительные категории')); ?>"
                                                              :title-or-name="<?php echo e(json_encode('title')); ?>"
                                    ...
                                    <div class=" col-md-2 form-group">
                                        ...
                                        <select id="stock_id" name="stock_id" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($id); ?>" <?php if($product->stock_id == $id): ?> selected <?php endif; ?>><?php echo e($title); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/veisdpua/test.veis.dp.ua/resources/views/admin/product/edit.blade.php ENDPATH**/ ?>