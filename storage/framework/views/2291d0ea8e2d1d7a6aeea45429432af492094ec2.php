        ...
        <nav class="navigation-bar d-flex flex-column">
            ...
            <div class="navigation-bar__submenu">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="<?php echo e(route('admin-way-to-pays-index')); ?>">Способы оплаты</a></li>
                </ul>
            </div>
            ...
            <div class="navigation-bar__submenu">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a class="nav-text" href="<?php echo e(route('admin-redirects-index')); ?>">Редиректы</a></li>
        ...
        <ul class="list-unstyled">
            <li>Русский:
                <button id="CopyUserButton" onclick="Copy(this)">
                    ...
                    <textarea style="display: none;" id="textid"><?php echo e(route('products-export')); ?>?lang=ru&display=xml</textarea>
                </button>
                <button><a href="<?php echo e(route('admin-products-export')); ?>?lang=ru"><i class="fas fa-download"></i></a>
                </button>
            </li>
            <li>Украинский:
                <button id="CopyUserButton" onclick="Copy(this)">
                    <i id="copyid" class="fas fa-copy"></i>
                    <textarea style="display: none;" id="textid"><?php echo e(route('products-export')); ?>?lang=uk&display=xml</textarea>
                </button>
                <button><a href="<?php echo e(route('admin-products-export')); ?>?lang=uk"><i class="fas fa-download"></i></a>
                </button>
            </li>
        </ul>
    </div>
...
<!-- <header class="header-desktop">
 ...
 --><?php /**PATH /home/veisdpua/test.veis.dp.ua/resources/views/layouts/admin/nav.blade.php ENDPATH**/ ?>