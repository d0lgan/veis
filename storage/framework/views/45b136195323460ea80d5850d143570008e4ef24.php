...
<head>
    ...
    <link href="<?php echo e(asset('css/app_admin.css')); ?>" rel="stylesheet">-->
    ...
    <!-- Main CSS-->
    <link href="<?php echo e(asset('css/theme.css')); ?>?<?php echo e(time()); ?>" rel="stylesheet" media="all">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/templatemo_main.css')); ?>">
...
<?php /**PATH /home/veisdpua/test.veis.dp.ua/resources/views/layouts/admin/app.blade.php ENDPATH**/ ?>