                ...
                <div id="app" class="w-100">
                    <div class="w-100">
                        ...
                        <div class="w-100 p-3" style="background-color: #fff">
                                ...
                                <div class="form-group">
                                    <div id="app">
                                        <select-component :default="<?php echo e(json_encode($group_attribute->categories)); ?>"
                                                          :categories="<?php echo e(json_encode($categories)); ?>"
                                                          :title="<?php echo e(json_encode('Категории')); ?>"
                                                          :title-or-name="<?php echo e(json_encode('title')); ?>"></select-component>
                                    </div>
                                </div>
                                <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/veisdpua/test.veis.dp.ua/resources/views/admin/group-attribute/edit.blade.php ENDPATH**/ ?>