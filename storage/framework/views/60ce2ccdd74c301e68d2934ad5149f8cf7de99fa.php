        ...
        <div class="conteiner">
            <div class="top__head">
                <nav style="padding-right: 60px">
                    ...
                    <div class="head__contact">
                        ...
                        <img src="<?php echo e(asset("assets/front/img/down_white.png")); ?>">
                    </div>
                    <div class="contact__hide">
                        <div class="contact__iteam">
                            <img src="<?php echo e(asset("assets/front/img/kievstar_black.jpg")); ?>">
                        ...
                        <div class="contact__iteam">
                            <img src="<?php echo e(asset("assets/front/img/vodafone_black.jpg")); ?>">
                        ...
                        <div class="contact__iteam">
                            <img src="<?php echo e(asset("assets/front/img/life_black.jpg")); ?>">
                        ...
                        <div class="contact__iteam contact__margin">
                            <img  src="<?php echo e(asset("assets/front/img/phone.jpg")); ?>">
                        ...
                        <div class="contact__iteam2">
                            <img src="<?php echo e(asset("assets/front/img/marker.jpg")); ?>">
                            <div class="contact__content">
            ...
            <div class="media__head">
                ...
                <div class="media__head_burger">
                    ...
                    <img src="<?php echo e(asset("assets/front/img/down.svg")); ?>" style="display: none;">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="conteiner">
            <div class="media__modal_iteam">
                ...
                <div class="head__contact  modal__hide">
                    <span><?php echo e(__('site.menu.contacts')); ?></span>
                    <img src="<?php echo e(asset("assets/front/img/down_white.png")); ?>" alt="">
                    <div class="contact__hide">
                        <div class="contact__iteam">
                            <img src="<?php echo e(asset("assets/front/img/kievstar_black.jpg")); ?>">
                            <a href="tel:380672740200">
                        ...
                        <a href="mailto:<?php echo e($receive_email); ?>" class="contact__email"><?php echo e($receive_email); ?></a>
                        <div class="contact__iteam contact__margin">
                            <img src="<?php echo e(asset("assets/front/img/phone.jpg")); ?>">
                            <div class="contact__content">
                                <p class="contact__title"><?php echo e(__('site.menu.call')); ?></p>
    ...
    <div class="bottom__head bottom__head--min">
        <div class="conteiner">
            <div class="bottom__block">
                ...
                <a href="<?php echo e(route('home')); ?>" class="logo logo--min media__logo_hide">VEIS<br><span>COLLECTION</span></a>
                <div class="block__number">
                    <div class="head__box">
                        <img class="vodafone__icon" id='foto' src="<?php echo e(asset("assets/front/img/kievstar.svg")); ?>" alt="vodafone">
                        <p id="phone"><?php echo e($phone_site_1); ?></p>
                        <img class="rotate" src="<?php echo e(asset("assets/front/img/down_white.png")); ?>" alt="">
                    </div>
                    <div class="number__hide">
                        <div class="number__block">
                            <a href="tel:380672740200" class="number__iteam">
                                <img class="vodafone__icon" src="<?php echo e(asset("assets/front/img/kievstar_black.jpg")); ?>" alt="vodafone">
                                <p><?php echo e($phone_site_1); ?></p>
                            </a>
                            <img src="<?php echo e(asset("assets/front/img/down.svg")); ?>" title="Свернуть окно" class="down__icon">
                        </div>
                        <a href="tel:380952740200" class="number__iteam">
                            <img class="vodafone__icon" src="<?php echo e(asset("assets/front/img/vodafone_black.jpg")); ?>" alt="vodafone">
                            <p><?php echo e($phone_site_2); ?></p>
                        </a>
                        <a href="tel:380732740200" class="number__iteam">
                            <img class="vodafone__icon" src="<?php echo e(asset("assets/front/img/life_black.jpg")); ?>" alt="vodafone">
...
<footer>
        <div class="foot__inner">
            <div class="foot__iteam">
                ...
                <a href="<?php echo e(route('catalog', ['f' => 'sontsezakhysni'])); ?>"><?php echo e(__('site.footer.sunglasses')); ?></a>
        ...
        <div class="media__foot">
            ...
            <div class="media__foot_hide">
                <a href="#/"><?php echo e(__('site.footer.about_us')); ?></a>
                <a href="#/"><?php echo e(__('site.footer.articles')); ?></a>
                <a href="#/"><?php echo e(__('site.footer.replies')); ?></a>
                <a href="<?php echo e(route('map')); ?>"><?php echo e(__('site.footer.map')); ?></a>
            </div>
...
</html><?php /**PATH /home/veisdpua/test.veis.dp.ua/resources/views/layouts/site/layout_with_short_header.blade.php ENDPATH**/ ?>